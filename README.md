...
├── models/                    # lung_triage_v1.pth (Neural weights)
├── outputs/                   # Generated figures and CSV ledgers
├── src/                       # Core Analytical Engine
│   ├── calculate_polarization_index.py # Lemaitre spatial math
│   ├── analyze_tb_jem.py              # WSI processor for TB cohorts
│   └── finalize_cancer_tb_metrics.py  # Final statistical reporting
...
2.  **Execute Full Spectrum Analysis:**
    ```bash
    python3 src/finalize_cancer_tb_metrics.py
    ```
